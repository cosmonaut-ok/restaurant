;;; restaurant-lite-theme.el --- a soothing theme with a pastel color palette

;; Author: Brian Mastenbrook <brian@mastenbrook.net>
;; Keywords: themes
;; URL: https://github.com/bmastenbrook/restaurant-lite-theme-el
;; Version: 1.0
...
(deftheme restaurant-lite
  "restaurant-lite, a soothing theme with a pastel color palette")
...
;;;###autoload
(defun restaurant-lite-theme ()
  "Load the restaurant-lite-theme."
  (interactive)
  (load-theme 'restaurant-lite t))

(provide-theme 'restaurant-lite)

;;; restaurant-lite-theme.el ends here
